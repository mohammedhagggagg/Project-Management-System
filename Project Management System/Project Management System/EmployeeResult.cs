...
{
    public partial class EmployeeResult : Form
    {
        ...
        private void Btn_Add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    context.SaveChanges();
                    //dataGridViewEmp.Rows.Add(employee.Id, employee.Name, employee.Email, employee.Phone, employee.Gender.ToString(), CB_Project.Text);
